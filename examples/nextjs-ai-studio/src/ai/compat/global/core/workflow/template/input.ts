...
export const Input_Template_History: FlowNodeInputItemType = {
  ...
  valueType: WorkflowIOValueTypeEnum.chatHistory, // Object / Number
...
export const Input_Template_File_Max_Length: FlowNodeInputItemType = {
  key: NodeInputKeyEnum.fileMaxLength,
