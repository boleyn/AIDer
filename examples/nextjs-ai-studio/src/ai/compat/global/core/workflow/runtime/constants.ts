...
export enum SseResponseEventEnum {
  ...
  mcpFilesystem = 'mcpFilesystem', // mcp filesystem panel

  scheduledTask = 'scheduledTask', // scheduled task card
  entryAppSelection = 'entryAppSelection' // entry app selection
}
