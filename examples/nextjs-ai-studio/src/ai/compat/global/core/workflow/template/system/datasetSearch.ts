...
export const DatasetSearchModule: FlowNodeTemplateType = {
  ...
  inputs: [
    ...
    },
    {
      ...
      renderTypeList: [FlowNodeInputTypeEnum.hidden], // 隐藏，通过搜索参数设置
      label: i18nT('workflow:use_private_dataset'),
      valueType: WorkflowIOValueTypeEnum.boolean,
      value: false,
      description: i18nT('workflow:use_private_dataset_description')
    },
    {
