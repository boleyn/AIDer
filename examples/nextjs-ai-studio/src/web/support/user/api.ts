...
import type { LoginSuccessResponse, ResLogin } from '@/global/support/api/userRes.d';
...
export const getTokenLogin = () =>
  GET<UserType>('/support/user/account/tokenLogin', {}, { maxQuantity: 1, skipTokenCheck: true });

export const ebossLogin = (data: { 'blade-auth': string; authorization: string }) =>
  POST<ResLogin>('/support/user/account/ebossLogin', data);
...
export const postRegister = ({
  ...
  POST<LoginSuccessResponse>(`/support/user/account/register/emailAndPhone`, {
    username,
    code,
    inviterId,
    bd_vid,
