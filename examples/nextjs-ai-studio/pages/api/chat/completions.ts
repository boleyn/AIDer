...
import { extractText, type IncomingMessage } from "../../../utils/agent/messages";
...
import { createId } from "../../../utils/agent/messages";
import type { AgentMessage } from "../../../utils/agent/messages";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const runResult = await runAgentCall({
    ...
    body: {
      model: runtimeConfig.toolCallModel,
