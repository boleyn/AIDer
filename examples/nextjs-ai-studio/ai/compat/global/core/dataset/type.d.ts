...
export type DatasetCollectionSchemaType = ChunkSettingsType & {
  ...
  metadata?: {
    ...
    // Path mapping fields for AI retrieval
    folderPath?: string[]; // Folder path array, e.g. ['项目文档', '2024年度']
    datasetName?: string; // Dataset name
    fullPath?: string; // Full path, e.g. '项目文档/2024年度/产品需求/需求文档.docx'
    filePath?: string; // File path (for AI quick read), same as fullPath
