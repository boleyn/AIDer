...
import { getHistorySummaryPrompt } from '../../../../ai/prompt/AIChat';
...
export const AiChatModule: FlowNodeTemplateType = {
  ...
  inputs: [
    ...
    Input_Template_History,
    {
      key: NodeInputKeyEnum.historySummaryEnabled,
      renderTypeList: [FlowNodeInputTypeEnum.hidden],
      label: '',
      valueType: WorkflowIOValueTypeEnum.boolean,
      value: false
    ...
    {
      key: NodeInputKeyEnum.historySummaryModel,
      renderTypeList: [FlowNodeInputTypeEnum.hidden],
      label: '',
      valueType: WorkflowIOValueTypeEnum.string
    },
    {
      key: NodeInputKeyEnum.historySummaryPrompt,
      renderTypeList: [FlowNodeInputTypeEnum.hidden],
      label: '',
      valueType: WorkflowIOValueTypeEnum.string,
      value: getHistorySummaryPrompt()
    },
    {
      key: NodeInputKeyEnum.historySummaryKeepRounds,
      renderTypeList: [FlowNodeInputTypeEnum.hidden],
      label: '',
      valueType: WorkflowIOValueTypeEnum.number,
      value: 6
    ...
    {
      key: NodeInputKeyEnum.historySummaryWindowRounds,
      renderTypeList: [FlowNodeInputTypeEnum.hidden],
      label: '',
      valueType: WorkflowIOValueTypeEnum.number,
      value: 12
    ...
    {
      key: NodeInputKeyEnum.historySummaryMaxTokens,
      renderTypeList: [FlowNodeInputTypeEnum.hidden],
      label: '',
      valueType: WorkflowIOValueTypeEnum.number,
      value: 256
