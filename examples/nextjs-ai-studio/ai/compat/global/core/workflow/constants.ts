...
export enum WorkflowIOValueTypeEnum {
  ...
  // long text custom types
  longTextOutline = 'longTextOutline',
  longTextOutlineItem = 'longTextOutlineItem',
  longTextParagraph = 'longTextParagraph',
  longTextParagraphs = 'longTextParagraphs',
...
export enum NodeInputKeyEnum {
  ...
  historySummaryEnabled = 'historySummaryEnabled',
  historySummaryModel = 'historySummaryModel',
  historySummaryPrompt = 'historySummaryPrompt',
  historySummaryKeepRounds = 'historySummaryKeepRounds',
  historySummaryWindowRounds = 'historySummaryWindowRounds',
  historySummaryMaxTokens = 'historySummaryMaxTokens',
  ...
  aiChatPromptCache = 'aiChatPromptCache',

  // dataset
  datasetSelectList = 'datasets',
  datasetSimilarity = 'similarity',
  datasetSearchRerankSimilarity = 'rerankSimilarity',
  ...
  // private dataset
  datasetUsePrivateDataset = 'datasetUsePrivateDataset',
  ...
  loopParallelLimit = 'loopParallelLimit',
  // loop start
  ...
  // long text
  longTextOutline = 'longtext_outline',
  longTextOutlineExtraPrompt = 'longtext_outline_extra_prompt',
...
export enum NodeOutputKeyEnum {
  ...
  // long text
  paragraphsJson = 'paragraphs_json',
  paragraphsMarkdown = 'paragraphs_markdown',
  longTextOutline = 'longtext_outline',
  longTextOutlineExtraPrompt = 'longtext_outline_extra_prompt',
  // File
  fileTitle = 'fileTitle',
...
export const ArrayTypeMap: Record<WorkflowIOValueTypeEnum, WorkflowIOValueTypeEnum> = {
  ...
  [WorkflowIOValueTypeEnum.longTextOutlineItem]: WorkflowIOValueTypeEnum.longTextOutline,
  [WorkflowIOValueTypeEnum.longTextOutline]: WorkflowIOValueTypeEnum.longTextOutline,
  [WorkflowIOValueTypeEnum.longTextParagraph]: WorkflowIOValueTypeEnum.longTextParagraphs,
  [WorkflowIOValueTypeEnum.longTextParagraphs]: WorkflowIOValueTypeEnum.longTextParagraphs,
